# PTS Watchlist Corpus — Abril/Mayo 2026

> **Fuente:** Reportes de Daniel Marin (Pro Trading Skills) consolidados en el bot de trading scalp_bot/Zenith.
> **Periodo:** 9 Abril – 25 Mayo 2026.
> **Propósito de este documento:** corpus único para análisis intensivo en NotebookLM. Cada sección (8c, 8d, ... 8k) es un reporte semanal de Daniel Marin más comentarios del operador del bot.
>
> **Glosario clave:**
> - **PHY** = patrón Head & Shoulders (macro = TF semanal/mensual).
> - **ZR** = Zona de Resistencia.
> - **BE** = Break Even (mover stop a precio de entrada).
> - **GR** = Garantía de Riesgo (% del capital arriesgado).
> - **MACRO_REGIME** = VERDE_BULL (SP500 > 7000) / AMARILLA_INDECISA (6800–7000) / NARANJA_BEAR (<6800).
> - **DEFENSIVE_SECTORS** = lista de símbolos que el bot NO filtra con bias bajista de equities.
> - **QUANTUM_SUPPRESSED** = símbolos cuánticos sobreextendidos (no reentry hasta corrección PTS).
>
> **Cómo se actualiza:** cada reporte PTS nuevo se agrega como sección 8X siguiente. El bot consume esto vía CLAUDE.md sección 8 + constantes en `config.py`.
